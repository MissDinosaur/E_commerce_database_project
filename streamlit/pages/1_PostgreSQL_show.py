...
tables_names = ['order_items', 'order_payments', 'order_reviews', 'orders', 'customers', 'geolocation', 'products', 'product_category_name_translation', 'sellers', 'leads_qualified', 'leads_closed']
...
def show_postgres_tables(tables_names: str):
    st.write("We have below tables in our Postgresql:")
    st.write(f"{tables_names}")
